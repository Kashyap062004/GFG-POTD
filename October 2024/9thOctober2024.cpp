...
class Solution {
  public:
  Node* LinkedMatrix(int i,int j,int n,int m,vector<vector<int>>& mat){
      if(i>n || j>m) return NULL;
      
      Node * t=new Node(mat[i][j]);
      
      t->right=LinkedMatrix(i,j+1,n,m,mat);
      t->down=LinkedMatrix(i+1,j,n,m,mat);
    ...
    Node* constructLinkedMatrix(vector<vector<int>>& mat) {
        ...
        return LinkedMatrix(0,0,n-1,m-1,mat);
    }
};
